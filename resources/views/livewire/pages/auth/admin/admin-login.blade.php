...
<div class="min-h-screen w-full flex items-center justify-center bg-[#f8fafc] p-4 m-0 font-['Raleway']">
    <div
        ...
        <div
            class="md:w-1/2 bg-gradient-to-br from-[#1e3a8a] to-[#3b82f6] p-3 md:p-12 text-white flex flex-col justify-center relative overflow-hidden min-h-[180px] md:min-h-[450px]">
